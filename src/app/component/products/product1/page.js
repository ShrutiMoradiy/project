    ...
    <>
      ...
      <section className="bg-[#f7f7f9] w-full py-10 md:py-16 lg:py-24 px-10 md:px-10 lg:px-36">
        <div className="container justify-center">
          ...
          <div className={`relative flex justify-center -bottom-40 -mt-20 ${isSidebarOpen ? "" : "relative flex justify-center -bottom-40 -mt-20"}`}>
      ...
      <section className="w-full py-10 md:py-16 lg:pb-28 px-10 md:px-10 lg:px-36">
        <div className="container justify-center">
          <div className="relative">
            ...
            <div className="lg:absolute inherit bg-white mt-10 lg:-mb-[50px] lg:right-0 lg:bottom-0 p-7 lg:p-12 border border-[#05f] rounded-xl lg:max-w-[40%]">
      ...
      <section className="w-full py-10 md:py-16 lg:pb-28 px-10 md:px-10 lg:px-36">
        <div className="container justify-center">
          <div className="relative">
            ...
            <div className="lg:absolute inherit mt-10 bg-white lg:-mb-[50px] lg:left-0 lg:bottom-0 p-7 lg:p-12 border border-[#05f] rounded-xl lg:max-w-[40%]">
              <h2 className="text-xl lg:text-2xl font-semibold text-[#343a40]">
                Features 2
              </h2>
              <p className="text-[#8a90a2] text-sm lg:text-base pt-4">
