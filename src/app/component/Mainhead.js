...
function Mainhead() {
  return (
    <>
    <section className="w-full px-10 bg-[url('/temp-imgs/hero-bg-1.png')]">
     <div className="container flex items-center justify-center lg:flex-nowrap flex-wrap gap-10 pt-10">
